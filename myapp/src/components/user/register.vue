  ...
  <div  class="login-wrap">
    <el-form  class="login-container" :rules="rules">
      ...
      <el-form-item label="" prop="email_val">
        <el-input type="text" placeholder="注册邮箱" v-model="email" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
